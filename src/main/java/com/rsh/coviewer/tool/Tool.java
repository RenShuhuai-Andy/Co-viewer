package com.rsh.coviewer.tool;

import com.alibaba.fastjson.JSON;
import com.baidu.aip.imagecensor.AipImageCensor;
import com.rsh.coviewer.tool.bean.Baidu;
...
//    private Lock lock = new ReentrantLock();
    ...
    private final static String txt = "一、总则\n" +
            "1.1 wsk1103的所有权和运营权归Co-viewer所有。\n" +
            "1.2 用户在注册之前，应当仔细阅读本协议，并同意遵守本协议后方可成为注册用户。一旦注册成功，则用户与Co-viewer之间自动形成协议关系，用户应当受本协议的约束。用户在使用特殊的服务或产品时，应当同意接受相关协议后方能使用。\n" +
            "1.3 本协议则可由Co-viewer随时更新，用户应当及时关注并同意本站不承担通知义务。本站的通知、公告、声明或其它类似内容是本协议的一部分。\n" +
            "二、服务内容\n" +
            "2.1 Co-viewer协议的具体内容由本站根据实际情况提供。\n" +
            "2.2 本站仅提供相关的网络服务，除此之外与相关网络服务有关的设备(如个人电脑、手机、及其他与接入互联网或移动网有关的装置)及所需的费用(如为接入互联网而支付的电话费及上网费、为使用移动网而支付的手机费)均应由用户自行负担。\n" +
            "三、用户帐号\n" +
            "3.1 经本站注册系统完成注册程序并通过身份认证的用户即成为正式用户，可以获得本站规定用户所应享有的一切权限；未经认证仅享有本站规定的部分会员权限。Co-viewer有权对会员的权限设计进行变更。\n" +
            ...
            "6.2 本站特有的标识、版面设计、编排方式等版权均属Co-viewer公司享有，未经本站许可，不得任意复制或转载。\n" +
            ...
            "七、责任声明\n" +
            "7.1 用户明确同意其使用本站网络服务所存在的风险及一切后果将完全由用户本人承担，Co-viewer对此不承担任何责任。\n" +
